...
button[0].addEventListener('click', (event) => {
    ...
    // nodes.
    event.stopPropagation();// make sure to use this as a function!!!
    ...
    console.log(event);
    event.toElement.innerText = 'DON\'T Click me';// don't use .outerText. that will get rid of the other stylings
});

//#region the below is the todo list
